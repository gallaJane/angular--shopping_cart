// NgModule provides the NgModule decorator, Common Module provides some directivs we weill need, 
// RouterModule nad Routes allows us to configure routing and FormModule allows us to use some features that angular2 provides to work with forms
...
@NgModule({
    imports: [ 
        CommonModule,
        FormsModule,
        RouterModule.forChild(AdminRoutes) // forChild we use for child Routes 
    ],
    exports: [
        RouterModule,
        TruncatePipe
